...
const AlternativeBarcodeScannerScreen = ({ navigation }) => {
            ...
            <View style={styles.header}>
              <Card style={styles.headerCard}>
                <Card.Content style={styles.headerContent}>
                  <Title style={styles.headerTitle}>Alternative Barcode Scanner</Title>
...
export default AlternativeBarcodeScannerScreen;